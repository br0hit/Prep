...
int dfs(int node, vector<int> &visited, vector<int> gr[], vector<int> &parent, int start, int count)
{
...
int bfs(int start, vector<int> &visited, vector<int> gr[], vector<int> &parent, vector<int> &distance)
{
    queue<int> qu;
    qu.push(start);
    visited[start] = 1;
